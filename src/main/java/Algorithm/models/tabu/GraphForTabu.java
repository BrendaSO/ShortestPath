...
public class GraphForTabu
{
    HashMap<Vertex, ArrayList<Connection>> nextList;

    public GraphForTabu(HashMap<Vertex, ArrayList<Connection>> nextList)
    {
    ...
    public ArrayList<Connection> shortestTimePath(Vertex start_stop, Vertex end_stop, TimeConv start_time)
    {
